...
<div class="container mt-5">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white text-center">
            <h2 class="mb-0">Chi tiết đĩa nhạc</h2>
        </div>
        <div class="card-body">
            <?php if ($product): ?>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?php else: ?>
                            <img src="/webbanhang/public/images/default-product-image.jpg" class="img-fluid rounded" alt="Không có ảnh">
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
                        <h3 class="card-title text-primary font-weight-bold"><?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?></h3>
                        ...
                        <div class="mt-4">
                            ...
                            <a href="/webbanhang/Product/list" class="btn btn-secondary px-4 ms-2">Quay lại danh sách</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                <div class="alert alert-danger text-center">
                    <h4>Không tìm thấy đĩa nhạc!</h4>
                </div>
            <?php endif; ?>
        </div>
    </div>
