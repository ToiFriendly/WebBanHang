...
class ProductModel
{
    ...
    {
        $query = "SELECT p.id, p.name, p.description, p.price, p.image, p.quantity, c.name as category_name FROM " . $this->table_name . " p LEFT JOIN category c ON p.category_id = c.id";
